...
public class CheckList {
    ...
    private boolean ProcessErrorCode(String[] enterData) {
        ...
        if (code == -1) {
            System.out.println("You didn't fill in all the data");
            CorrectData = false;
            return false;
        } else if (code == 1) {
            System.out.println("You entered more data than expected");
            CorrectData = false;
            return false;
        }
        return true;
            ...
            if (Character.isDigit(tempString.charAt(0))) {
                ...
                if (tempString.equals("m") || tempString.equals("f")) {
                    ...
                    throw new RuntimeException(
                            "You have incorrectly indicated your gender, specify m or f");
                }
